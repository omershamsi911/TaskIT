...
// ---------------------------------------------------------------------------
// Light‑theme colour palette (mirrors your useTheme)
// ---------------------------------------------------------------------------
const C = "#ff4d2d";        // Coral
const CR = "#fdfbf7";       // Cream background
const IK = "#1a1a1a";       // Ink (borders/text)
const LIGHT_IK = "#6b6b6b"; // Muted text
